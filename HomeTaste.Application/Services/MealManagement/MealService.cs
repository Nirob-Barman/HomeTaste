        ...
        public async Task<Result<int>> BulkInsertPredefinedMealsAsync()
        {
            try
            {
                ...
                var meals = new List<MealRequestWithCategoryName>
                {
                    ...
                    new MealRequestWithCategoryName { Name = "Kosha Mangsho", Description = "A slow-cooked, spicy mutton curry, a traditional Bengali delicacy often served with rice or paratha.", Price = 350, CategoryName = "Non-Vegetarian", ImageUrl = "https://example.com/images/kosha_mangsho.jpg" },
                    new MealRequestWithCategoryName { Name = "Tandoori Chicken", Description = "Chicken marinated with yogurt and spices, then cooked in a tandoor oven for a smoky flavor.", Price = 350, CategoryName = "Non-Vegetarian", ImageUrl = "https://example.com/images/tandoori_chicken.jpg" },
                    new MealRequestWithCategoryName { Name = "Butter Chicken", Description = "Chicken cooked in a creamy tomato-based gravy, spiced with aromatic herbs and butter.", Price = 400, CategoryName = "Non-Vegetarian", ImageUrl = "https://example.com/images/butter_chicken.jpg" },
                    new MealRequestWithCategoryName { Name = "Chicken Korma", Description = "A rich, mildly spiced chicken curry made with yogurt, cream, and ground nuts.", Price = 380, CategoryName = "Non-Vegetarian", ImageUrl = "https://example.com/images/chicken_korma.jpg" },
                    new MealRequestWithCategoryName { Name = "Mutton Rogan Josh", Description = "A flavorful, aromatic mutton curry cooked with a variety of spices, yogurt, and tomatoes.", Price = 450, CategoryName = "Non-Vegetarian", ImageUrl = "https://example.com/images/mutton_rogan_josh.jpg" },
                    new MealRequestWithCategoryName { Name = "Fish Tikka", Description = "Fish marinated in a mix of yogurt and spices, then grilled to perfection, often served with a tangy mint chutney.", Price = 300, CategoryName = "Non-Vegetarian", ImageUrl = "https://example.com/images/fish_tikka.jpg" },
                    new MealRequestWithCategoryName { Name = "Prawn Masala", Description = "Prawns cooked in a spicy and tangy masala gravy with tomatoes and onions.", Price = 450, CategoryName = "Non-Vegetarian", ImageUrl = "https://example.com/images/prawn_masala.jpg" },
                    new MealRequestWithCategoryName { Name = "Chicken Biryani", Description = "A fragrant rice dish made with spices, marinated chicken, and cooked together with saffron rice.", Price = 400, CategoryName = "Non-Vegetarian", ImageUrl = "https://example.com/images/chicken_biryani.jpg" },
                    new MealRequestWithCategoryName { Name = "Mutton Keema", Description = "Ground mutton cooked with spices, peas, and tomatoes, often served with paratha or rice.", Price = 380, CategoryName = "Non-Vegetarian", ImageUrl = "https://example.com/images/mutton_keema.jpg" },
                    new MealRequestWithCategoryName { Name = "Prawn Malai Curry", Description = "A mild, creamy prawn curry made with coconut milk and fragrant spices.", Price = 400, CategoryName = "Non-Vegetarian", ImageUrl = "https://example.com/images/prawn_malai_curry.jpg" },
